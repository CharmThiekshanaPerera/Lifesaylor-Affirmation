  ...
  const onboardingData = [
    {
      ...
      name: 'Step 1',
      description: 'Welcome to Habits! This is the first step of the habit process. You can select our pre defined habits',
    },
    {
      image: require('../../../assets/Doc/4.png'),
      name: 'Step 2',
      description: 'Here you can see the second step. If you want to create habits by your own, you can use create habit',
    },
    {
        image: require('../../../assets/Doc/7.png'),
        name: 'Step 3',
        description: 'This is the third step of the habit process. You can give a name for your own created habit',
      },
    {
      image: require('../../../assets/Doc/6.png'),
      name: 'Step 4',
      description: 'This is the final step of the habit process. you can set reminders for your pre habits and your own habits ',
    },
